"""
Django settings for unifiedcomms_45932 project.
...
ROOT_URLCONF = 'unifiedcomms_45932.urls'
...
WSGI_APPLICATION = 'unifiedcomms_45932.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "unifiedcomms_45932 API",
    "DESCRIPTION": "API documentation for unifiedcomms_45932 App",
    "VERSION": "v1",
}
